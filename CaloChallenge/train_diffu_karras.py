...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for i, (E,data) in tqdm(enumerate(loader_train, 0), unit="batch", total=len(loader_train)):
            ...
            batch_loss = model.compute_loss_karras(data, E, noise = noise, t = sigma, energy_loss_scale = energy_loss_scale)
            batch_loss.backward()
        ...
        for i, (vE, vdata) in tqdm(enumerate(loader_val, 0), unit="batch", total=len(loader_val)):
            ...
            batch_loss = model.compute_loss_karras(vdata, vE, noise = noise, t = sigma, energy_loss_scale = energy_loss_scale)
